...
static const uint8_t RES_QVGA[][2]={
	//{REG_COM7, 0x00},
...
//According to OV7670/7171 implementation guide v1.0 - Table 2-2
static const uint8_t RES_QQVGA[][2]={
	//{REG_COM7, 0x00},
	{REG_COM3, 0x04},  				// DCW enable
...
static const uint8_t RES_QQQVGA[][2]={
	//{REG_COM7, 0x00},
	{REG_COM3, 0x04},  				// DCW enable
...
//According to OV7670/7171 implementation guide v1.0 - Table 2-2
static const uint8_t RES_CIF[][2]={
	//{REG_COM7, 0x00},
	{REG_COM3, 0x08 },
	{REG_COM14, 0x11},
	{REG_SCALING_XSC, 0x3A},  // scaling_xsc
...
//According to OV7670/7171 implementation guide v1.0 - Table 2-2
static const uint8_t RES_QCIF[][2]={
	//{REG_COM7, 0x00},
	{REG_COM3, 0x0C},
	{REG_COM14, 0x11},
...
//According to OV7670/7171 implementation guide v1.0 - Table 2-2
static const uint8_t RES_QQCIF[][2]={
	//{REG_COM7, 0x00},
	{REG_COM3, 0x0C},
	{REG_COM14, 0x12},
	{REG_SCALING_XSC, 0x3A},
